#!/usr/bin/env python3
"""
Simple version bump helper for sdk/pyproject.toml and git tag creation.
...
def main() -> int:
    ...
    print(f"Next: git commit -am 'sdk: bump to {version}' && git tag sdk-py-v{version} && git push origin main sdk-py-v{version}")
    return 0
